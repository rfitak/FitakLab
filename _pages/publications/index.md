...
<div class="lab-wrapper">
    ...
    {% if pub.year == 2020 %}
     <li><p><a href="{{ pub.doi }}"><b>{{ pub.title }}</b></a>
      ...
      <script type="text/javascript" src="https://d1bxh8uas1mnw7.cloudfront.net/assets/embed.js"></script><span class="altmetric-embed" data-badge-type="donut" data-altmetric-id="41788310" width="50"></span>
      {% if pub.pdf %}
