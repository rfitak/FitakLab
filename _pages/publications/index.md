...
<div align="center" style="clear:both"><h2><b>2026</b></h2></div>
...
<div align="center" style="clear:both"><h2><b>2025</b></h2></div>
<div class="lab-wrapper">
    <ul class="lab-list">
    {% for pub in site.data.publications %}
    {% if pub.year == 2025 %}
...
<div align="center" style="clear:both"><h2><b>2024</b></h2></div>
<div class="lab-wrapper">
    <ul class="lab-list">
    {% for pub in site.data.publications %}
    {% if pub.year == 2024 %}
...
<div align="center" style="clear:both"><h2><b>2023</b></h2></div>
<div class="lab-wrapper">
    <ul class="lab-list">
    {% for pub in site.data.publications %}
    {% if pub.year == 2023 %}
...
<div align="center" style="clear:both"><h2><b>2018 and earlier</b></h2></div>
<div class="lab-wrapper">
    <ul class="lab-list">
    {% for pub in site.data.publications %}
    {% if pub.year < 2019 %}
